...
<div align="center">
  ...
  <img src="{{ '/assets/images/dmit-lax-pro/IPv6去程/北京联通.png' | relative_url }}" alt="IPv6 去程路由 2" width="32%" />
...
**白天**
![ITDOG 多地延迟测试 · 白天]({{ '/assets/images/dmit-lax-pro/多地Ping值测试/DMIT.LAX.Pro_多地Ping值测试_白天.png' | relative_url }})

**晚高峰**
![ITDOG 多地延迟测试 · 晚高峰]({{ '/assets/images/dmit-lax-pro/多地Ping值测试/DMIT.LAX.Pro 多地Ping值测试_晚高峰.png' | relative_url }})
