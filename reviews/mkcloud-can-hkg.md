...
- **端内实时状态监控**：<https://ping.nxtrace.org/goto/bflixzqbb04xsc>
- **端内状态监控截图**：
  <details markdown="1">
...
![Apple CDN 测速]({{ '/assets/images/mkcloud-can-hkg/CDN测速/截屏2026-05-08 下午3.07.47.png' | relative_url }})
...
![Cloudflare CDN 测速]({{ '/assets/images/mkcloud-can-hkg/CDN测速/截屏2026-05-08 下午3.07.52.png' | relative_url }})
