...
- [**官方购买入口**](https://www.mkcloud.net/aff.php?aff=356&gid=16)
...
- 超量策略：1TB / 2TB 为超量停机；3TB 为超量不停机限速 10Mbps；6TB 为超量不停机限速 20Mbps。
...
这款沪日 IPLC 上云互联优化（IXP）是典型的云厂前置型产品：入口 IP 仅在 IX 内宣告，只有加入 IX 的云厂网络可以访问，三大网络无法直接连接。

它的核心优势是入口成本更低、流量配比更高。当前实测中，Google / Cloudflare / AWS / GitHub 基本在 25~27ms 区间，整体延迟和波动较稳定，端内时延约 25ms。我的测试机是 200Mbps 端口款，搭配腾讯云 200M 前置可稳定跑满端口。适合云到云互联和中转落地用户；若需求是家宽直连可用，建议选择非 IXP 入口版本。
...
![Apple CDN 测速]({{ '/assets/images/mkcloud-ix-sha-nrt/CDN测速/截屏2026-05-08 下午3.09.48.png' | relative_url }})
...
![Cloudflare CDN 测速]({{ '/assets/images/mkcloud-ix-sha-nrt/CDN测速/截屏2026-05-08 下午3.09.49.png' | relative_url }})
