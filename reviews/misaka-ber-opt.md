...
**白天**
![ITDOG 多地延迟测试 · 白天]({{ '/assets/images/misaka-ber-opt/多地Ping值测试/misaka-ber-opt_多地Ping值测试_白天.png' | relative_url }})

**晚高峰**
![ITDOG 多地延迟测试 · 晚高峰]({{ '/assets/images/misaka-ber-opt/多地Ping值测试/Misaka.BER.Opt 多地Ping值测试_晚高峰.png' | relative_url }})
...
![Apple CDN 测速]({{ '/assets/images/misaka-ber-opt/CDN测速/截屏2026-05-08 下午2.27.50.png' | relative_url }})
...
![Cloudflare CDN 测速]({{ '/assets/images/misaka-ber-opt/CDN测速/截屏2026-05-08 下午2.27.59.png' | relative_url }})
